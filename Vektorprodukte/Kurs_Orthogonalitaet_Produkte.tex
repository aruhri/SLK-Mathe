...
\item Überlegen Sie, wie diese Verschiebung mitallen zu einem Vektor
  orthogonale Vektoren im $\mathbb{R}^3$ aussieht. Wie viele gleich
...
\begin{align*}
|\vec{b} - \vec{a}|&=\sqrt{(b_1-a_1)^2 + (b_2-a_2)^2}\\
\intertext{Quadrieren um die Wurzel loszuwerden und Anwenden der binomischen
  Formeln ergibt dann:}
...
Die im vorigen Abschnitt verwendete Rechenart heißt das {\em
